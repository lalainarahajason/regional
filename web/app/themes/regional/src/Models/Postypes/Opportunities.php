...
class Opportunities implements HooksInterface{
    ...
    public function initPostType(){
        ...
        $name 	= PostType::CPT_OPPORTUNITIES;
        $type = substr($name, -1);
        ...
        register_post_type(PostType::CPT_OPPORTUNITIES , apply_filters("opportunities_register_" . PostType::CPT_OPPORTUNITIES . "_post_type", $args) );
