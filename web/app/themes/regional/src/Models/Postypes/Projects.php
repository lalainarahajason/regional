 ...
 * @since 1.0.0
 */
class Projects implements HooksInterface{
    ...
    public function initPostType(){
        ...
        register_post_type(PostType::CPT_PROJECTS , apply_filters("projects_register_" . PostType::CPT_OPPORTUNITIES . "_post_type", $args) );
